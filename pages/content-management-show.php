...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
    <h2><?php echo WP_PopUpFad_TITLE; ?><a class="add-new-h2" href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=cool-fade-popup&amp;ac=add">Add New</a></h2>
    <div class="tool-box">
	<?php
		$sSql = "SELECT * FROM `".WP_PopUpFad_TABLE."` order by PopUpFad_id desc";
		$myData = array();
      ...
      <table width="100%" class="widefat" id="straymanage">
		...
		<tbody>
			...
			{
				if($data['PopUpFad_status'] == 'YES') 
				{
					$displayisthere = TRUE; 
				}
				?>
				<tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
					<td align="left"><input type="checkbox" value="<?php echo $data['PopUpFad_id']; ?>" name="PopUpFad_group_item[]"></th>
				  <td><?php echo stripslashes($data['PopUpFad_text']); ?>
					<div class="row-actions">
						<span class="edit"><a title="Edit" href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=cool-fade-popup&amp;ac=edit&amp;did=<?php echo $data['PopUpFad_id']; ?>">Edit</a> | </span>
	  ...
	  <div class="tablenav">
	  <h2>
	  <a class="button add-new-h2" href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=cool-fade-popup&amp;ac=add">Add New</a>
	  <a class="button add-new-h2" href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=cool-fade-popup&amp;ac=set">Widget setting</a>
	  <a class="button add-new-h2" target="_blank" href="<?php echo WP_PopUpFad_FAV; ?>">Help</a>
	  </h2>
	  </div>
